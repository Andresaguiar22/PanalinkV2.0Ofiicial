...
* **Beta**: `v1.3.43-beta`, code `70`, SHA `b3256716c092d85feae7f4111255574b23b7fb410a426edf58d534df805f46a8`, package `com.panalink.app.beta`, firma `CN=Panalink Beta`, ABIs `arm64-v8a`+`armeabi-v7a`. URLs (hosts de esta sesión, confirmar con curl -sI):
  - `https://work-2-raisotzdcnuptyzh.prod-runtime.all-hands.dev/Panalink-BETA-v1.3.43-code70.apk` (puerto 12001, serve_range.py).
  - `https://work-1-raisotzdcnuptyzh.prod-runtime.all-hands.dev/apk/Panalink-BETA-v1.3.43-code70.apk` (puerto 12000, capture_server.py).
